...
function calculate_progress(web3Global,contractEthBalance){
  ...
  const completed = Math.round((Math.round(total_bought) / total_tokens) * 100)
  ...
  return (
    ...
    <title>FlyGuyz</title>
    {/* Favicon */}
    <link rel="shortcut icon" href="img/flyguyz-favicon.png" type="image/x-icon" />
    {/* Fonts */}
    <link rel="preconnect" href="https://fonts.googleapis.com" />
    <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin />
    <link href="https://fonts.googleapis.com/css2?family=Russo+One&family=Ubuntu:wght@400;500;700&display=swap" rel="stylesheet" />
    {/* Boostrap CSS */}
    ...
    <nav className="navbar navbar-expand-lg">
      <div className="container-xxl flex-nowrap">
        ...
        <a className="navbar-brand" href="index.html"><img src="img/flyguyz-logo.png" className="img-fluid" alt="FlyGuyz" /></a>
        <ul className="navbar-nav ms-auto mb-lg-0">
          <li className="nav-item">
            <a className="btn btn-blue" aria-current="page" onClick={connect_wallet}>{connectBtnText}</a>
          </li>
        </ul>
      </div>
    </nav>
            ...
            <ul className="navbar-nav">
              <li className="nav-item">
                <a href="#" className="nav-link">
                  <i className="icon">
                    <img src="img/icons/tokenization.svg" alt="Buy Tokens" className="img-fluid" />
                  </i>
              ...
              <li className="nav-item">
                <a href="https://www.flyguyz.io/" className="nav-link">
                  <i className="icon">
                    <img src="img/icons/home.svg" alt="Home" className="img-fluid" />
                  </i>
                  <span>Home</span>
                </a>
              </li>
              <li className="nav-item">
                <a href="https://www.flyguyz.io/litepaper.html" className="nav-link">
                  <i className="icon">
                    <img src="img/icons/bird.svg" alt="Litepaper" className="img-fluid" />
                  </i>
                  <span>Litepaper</span>
                </a>
              </li>
              <li className="nav-item">
                <a href="https://www.flyguyz.io/index.html#roadmap" className="nav-link">
                  <i className="icon">
          ...
          <div className="wrap px-lg-4 px-xl-5">
            ...
            <div className="private-sale">
              <div className="page-header">
                <h2 className="page-heading text-uppercase">Private round (WHITELIST OPENED)</h2>
              </div>
              {/* <div class="note mb-5">
              ...
              <div className="row">
                    ...
                    <div className="card-inner after-content">
                      ...
                      <div className="pt-3 pb-3 card-body">
                        ...
                        <div className="coin-swap mb-3">
                          <div className="row align-items-center">
                            <div className="col-lg-2 col-md-3 mb-4 mb-md-0">
                              <span className="token token-with-ticker">
                                <img src="img/ethereum.svg" alt="ethereum" className="img-fluid" />
                          ...
                          <div class="nouislider text-primary">
                            <div class="noUi-target noUi-ltr noUi-horizontal noUi-txt-dir-ltr">
                              ...
                              <form className="w-100">
                                <div className="slider">
                                  ...
                                  <div className="range">
                                    <input type="range" onChange={onEthValueInputHandler} className="form-range"  min={0.0000135} max={1000000} defaultValue={0.0000135} required />
                            ...
                            <div className="col-lg-2 col-md-3">
                              <input type="number" onChange={onEthManuallyValueInputHandler} className="form-control" min={0.0000135} max={1000000} defaultValue={selectedEthValue} value={selectedEthValue} />
                            </div>
                          </div>
                        </div>
                        <div className="coin-swap-arrow">
                          <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="arrow-down" className="svg-inline--fa fa-arrow-down fa-2x" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                        ...
                        <div className="coin-swap igu-token mb-3">
                          <span className="token token-with-ticker">
                            <span className="token-left">
                              <img src="img/icons/flyguyz-icon.png" alt="FlyGuyz" />
                        ...
                        <div className="h5 tooltip-calculate-result">
                          Avg. Price<small className="text-muted">
                      ...
                      {!isWalletConnected && (
                        <button type="button" onClick={connect_wallet} className="btn-buy d-block w-100 text-uppercase btn btn-blue">Connect
                        wallet</button>
                        )}
                        {isWalletConnected && (
                        <button type="button" onClick={buy} className="btn-buy d-block w-100 text-uppercase btn btn-blue">Buy!</button>
                        )}
                        ...
                        <div className="row">
                          <div className="col-7">
                            <div className="text-center text-primary">
                              ...
                              <hr />
                              <p className="mb-0 text-uppercase text-primary">Private round</p>
                            </div>
                          </div>
                          <div className="col-5">
                            <div className="text-center">
                              ...
                              <hr />
                              <p className="text-muted mb-0 text-uppercase">Public round</p>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="mb-4 fundraising-card col-xl-8 col-lg-12 col-md-12">
                  <div className="h-100 card">
                    <div className="py-4 card-header">
                      <h6 className="card-heading">Private sale Fundraising</h6>
                    </div>
                    <div className="pt-3 pb-0 card-body">
                      <div className="h2 mb-3 text-accent text-uppercase">{progressPercentage}</div>
                      <div className="align-items-center mb-3 row">
                        <div className="fundraising-element mb-3 mb-md-0 text-muted fw-bold text-round col-lg-2 col-md-2">Completed</div>
                        <div className="fundraising-element mb-3 mb-md-0 col-lg-7 col-md-6">
                          <div className="progress">
                            <div role="progressbar" className="progress-bar bg-green progress-bar-animated progress-bar-striped" aria-valuenow={0} aria-valuemin={0} aria-valuemax={100} style={{width: progressPercentage}}>{progressPercentage}
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="mb-3 row">
                        <div className="col-lg-6">
                          ...
                          <ul>
                            ...
                            <li>
                              <p><small className="text-muted">Hard Cap: </small><strong><span>$1,500,000</span></strong></p>
                            </li>
                            {/* <li>
                        <p><small class="text-muted">Private sale supply: </small><b>35,000,000 FLYY</b></p>
                      </li> */}
                            <li>
                              <p><small className="text-muted">Max supply: </small><b>888,000,000 FLYY</b></p>
                            </li>
                          </ul>
                        </div>
                        <div className="col-lg-6">
                          <p><b>Round details:</b></p>
                          <ul>
                            <li>
                              <p><small className="text-muted">Min. allocation: </small><b><span>$100</span></b></p>
                            </li>
                            <li>
                              <p><small className="text-muted">Max. allocation: </small><b><span>$50,000</span></b></p>
                            </li>
                            <li>
                              <p><small className="text-muted">Price: </small><b>1 FLYY = 0.02$</b></p>
                            </li>
                            {/* <li>
              ...
              <div className="row">
                ...
                <div className="text-center text-md-start fw-bold col-md-6">
                  <ul className="social-list">
                    <li><a className="social-list-item social-discord" href="#" target="_blank" rel="noreferrer"><i className="icon-discord" /></a></li>
                    <li><a className="social-list-item social-telegram" href="#" target="_blank" rel="noreferrer"><i className="icon-telegram" /></a></li>
                    <li><a className="social-list-item social-twitter" href="#" target="_blank" rel="noreferrer"><i className="icon-twitter" /></a></li>
                    <li><a className="social-list-item social-binance" href="#" target="_blank" rel="noreferrer"><i className="icon-binance" /></a></li>
                    <li><a className="social-list-item social-opensea" href="#" target="_blank" rel="noreferrer"><i className="icon-opensea" /></a></li>
                    <li><a className="social-list-item social-cmc" href="#" target="_blank" rel="noreferrer"><i className="icon-cmc" /></a></li>
                    <li><a className="social-list-item social-linktree" href="#" target="_blank" rel="noreferrer"><i className="icon-linktree" /></a></li>
                  </ul>
                </div>
